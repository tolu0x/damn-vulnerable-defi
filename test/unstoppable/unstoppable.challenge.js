...
describe("[Challenge] Unstoppable", function () {
  ...
  it("Execution", async function () {
    ...
    /*
            The goal of this challenge is to cause a denial of service to the flashLoan function of the UnstoppableVault contract. We can achieve that by making one of the conditional statements revert, thereby making it unusable.
            There is a conditional statement that checks if the amount of shares of the totalSupply is equal to the totalAssets in the contract and it reverts if it's false. We can make this line revert by changing the state of the contract's balance of DVT. This can be achieved by making a direct ERC20 transfer of any amount of DVT to the vault.
